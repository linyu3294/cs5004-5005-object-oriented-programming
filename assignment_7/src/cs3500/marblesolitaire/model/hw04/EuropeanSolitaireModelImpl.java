...
/**
 * An European Solitaire model extended from the abstract model.
 */
public class EuropeanSolitaireModelImpl extends AbstractSolitaireModelImpl {
  ...
  public EuropeanSolitaireModelImpl() {
    this.board = new EuroBoard(3,3,3);
    this.orthoRules = new OrthoRules(board);
    this.gameOver = new GameOver(board);
  }

  /**
   * This is the second constructor. It takes one parameter, scale. It initializes the game board.
   *
   * @param scale - an integer that determines the size of a board.
   */
  public EuropeanSolitaireModelImpl(int scale) {
    this.board = new EuroBoard(scale,
  ...
  /**
   * This is the third constructor. It takes two parameters, row and column. It initializes the
   * game board.
   *
  ...
  public EuropeanSolitaireModelImpl(int sRow, int sCol) {
    this.board = new EuroBoard(3, sRow, sCol);
    this.orthoRules = new OrthoRules(board);
    this.gameOver = new GameOver(board);
  }

  /**
   * This is the fourth constructor. It takes in three parameters, scale, column and row. It
   ...
   * @param sCol  - an integer that represents the column.
   */
  public EuropeanSolitaireModelImpl(int scale, int sRow, int sCol) {
    this.board = new EuroBoard(scale, sRow, sCol);
    this.orthoRules = new OrthoRules(board);
    this.gameOver = new GameOver(board);
  }
