...
/**
 * OrthoRules class is used to verify if a move pattern is valid.
 * OrthoRules Implements IRules.
 * OrthoRules dictates that a move direction can only move horizontally or vertically.
 * OrthoRules dictates that the source cannot be out of Bound.
 * OrthoRules dictates that the source cannot be empty.
 * OrthoRules dictates that the destination cannot be out of Bound.
 * OrthoRules dictates that the destination must be empty.
 * OrthoRules dictates that the middle square (between source and destination) must be occupied.
 */
