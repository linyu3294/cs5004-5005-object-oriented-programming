...
public class MarbleSolitaireModelImplTest {
  ...
  public void constructorTest1() {
    ...
    board = new CrossBoard(1, 3);
    assertEquals("X", board.checkSquareState(1, 3));
  }

  @Test
  public void constructorTest2() {
    MarbleSolitaireModel newMarble = new MarbleSolitaireModelImpl(0, 4);
    board = new CrossBoard(0, 4);
    assertEquals("X", board.checkSquareState(0, 4));
  }

  @Test
  public void constructorTest3() {
    MarbleSolitaireModel newMarble = new MarbleSolitaireModelImpl(4, 5);
    board = new CrossBoard(4, 5);
    assertEquals("X", board.checkSquareState(4, 5));
  ...
  public void constructorTest4() {
    ...
    board = new CrossBoard(6, 2);
    assertEquals("X", board.checkSquareState(6, 2));
  ...
  public void moveRightTest() {
    ...
    assertEquals("X", board.checkSquareState(3, 1));
    assertEquals("X", board.checkSquareState(3, 2));
  }
  ...
  public void moveLeftTest() {
    ...
    assertEquals("O", board.checkSquareState(3, 3));
    assertEquals("X", board.checkSquareState(3, 5));
    assertEquals("X", board.checkSquareState(3, 4));
  }
  ...
  public void moveUpTest() {
    ...
    assertEquals("O", board.checkSquareState(3, 3));
    assertEquals("X", board.checkSquareState(4, 3));
    assertEquals("X", board.checkSquareState(5, 3));
  }
  ...
  public void moveDownTest() {
    ...
    assertEquals("O", board.checkSquareState(3, 3));
    assertEquals("X", board.checkSquareState(1, 3));
    assertEquals("X", board.checkSquareState(2, 3));
  }
  ...
  public void gameOverTest() {
    ...
    assertEquals(false, ortho.gameOver(board));
    ...
    assertEquals(true, ortho.gameOver(board));
  }
}